...
page_sections:
  ...
  - block: hero-1
    ...
    content:
      ...
      <p>
        ...
        <br><br>
        Runs from December 24 - January 23. <br>
        <strong>Registration closes on Friday, December 24.</strong>
  ...
  - block: three-column-1
    ...
    col_1:
      headline: Dates
      content:
        Runs from Dec 24 - Jan 17.<br>
        Five total check-ins - first one due Sun, Dec 26.
    col_2:
